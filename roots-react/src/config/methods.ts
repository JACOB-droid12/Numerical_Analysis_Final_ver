...
export const METHOD_CONFIGS: MethodConfig[] = [
  {
    ...
    tableHeaders: ['n', 'p_n', 'f(p_n)', 'Kept interval', 'Bound', 'Error', 'Check'],
    fields: [
  ...
  },
  {
    ...
    tableHeaders: ['n', 'p_n', 'f(p_n)', "f'(p_n)", "Correction f/f'", 'p_{n+1}', 'Error', 'Check'],
    fields: [
  ...
  },
  {
    ...
    runLabel: 'Run secant',
    tableHeaders: ['n', 'p_{n-1}', 'p_n', 'f(p_{n-1})', 'f(p_n)', 'p_{n+1}', 'Error', 'Check'],
    fields: [
  ...
  },
  {
    ...
    tableHeaders: ['n', 'p_n', 'f(p_n)', 'Retained interval', 'Width', 'Error', 'Check'],
    fields: [
  ...
  },
  {
    ...
    tableHeaders: ['n', 'p_n', 'g(p_n)', 'Error', 'Check'],
    fields: [
